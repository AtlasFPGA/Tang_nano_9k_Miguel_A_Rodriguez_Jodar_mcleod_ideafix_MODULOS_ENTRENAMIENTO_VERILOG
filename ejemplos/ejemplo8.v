...
/*
   ...
   Mejoramos un poco el cronómetro del EJEMPLO 7. Lo que vamos a hacer es conseguir que
   el cronómetro cuente en decimal y no en hexadecimal. Para ello usaremos 4 digitos
   (los 4 centrales del display) para almacenar unidades, decenas, centenas y unidades
   de millar, y un quinto dígito a la derecha de los anteriores, para guardar décimas de
   segundo, como en el ejemplo anterior. El procedimiento es análogo al que hemos usado para
   contar décimas de segundo, que al llegar a 9 pasan a 0 y hacen incrementar los segundos.
   En este caso haremos incrementos en cadena: cuando las décimas valen 9, hacen incrementar
   a las unidades. Cuando las unidades valen 9, hacen incrementar las decenas. Cuando las
   decenas valen 9, hacen incrementar las centenas, etc.
   De esta manera, el cronómetro puede contar hasta 9999.9 segundos.
*/   
