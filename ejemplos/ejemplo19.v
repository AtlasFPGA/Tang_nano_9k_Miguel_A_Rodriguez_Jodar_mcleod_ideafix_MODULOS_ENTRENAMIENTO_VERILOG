...
*/   
  ...
  localparam COLOR_CASILLA = {6'h3C, 6'h21, 6'h1C};   // color salmón
  ...
  always @* begin
    if (display_activo == 1'b1) begin
      ...
      else if (posx[10:5] == cruz_x[10:5] && posy[10:5] == cruz_y[10:5])  // si posx,posy caen en una casilla donde está la cruz...
        {rojo,verde,azul} = COLOR_CASILLA;
      else   
